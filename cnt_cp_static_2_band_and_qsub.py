...
#os.system('cd ../band')
os.chdir('/home/users/xiangye/fzxl/carbonnanotube/cnt99/2tube/16/isolated/caledinSHNU/band')
os.system('pwd')
...
os.system('cp POSCAR CHG CHGCAR ../band')
#os.system('cd ../band')
os.chdir('/home/users/xiangye/fzxl/carbonnanotube/cnt99/2tube/17/isolated/caledinSHNU/band')
os.system('pwd')
os.system('qsub vasp.pbs')
...
os.system('cp POSCAR CHG CHGCAR ../band')
#os.system('cd ../band')
os.chdir('/home/users/xiangye/fzxl/carbonnanotube/cnt99/2tube/18/isolated/caledinSHNU/band')
os.system('pwd')
os.system('qsub vasp.pbs')
...
os.system('cp POSCAR CHG CHGCAR ../band')
#os.system('cd ../band')
os.chdir('/home/users/xiangye/fzxl/carbonnanotube/cnt99/2tube/19/isolated/caledinSHNU/band')
os.system('pwd')
os.system('qsub vasp.pbs')
...
os.system('cp ../../../../../1tube/isolated/caledinSHNU/LDA/band/vasp.pbs ../band')
os.system('cp POSCAR CHG CHGCAR ../band')
os.chdir('/home/users/xiangye/fzxl/carbonnanotube/cnt99/2tube/20/isolated/caledinSHNU/band')
#os.system('cd ../band')
os.system('pwd')
os.system('qsub vasp.pbs')
...
os.system('cp POSCAR CHG CHGCAR ../band')
#os.system('cd ../band')
os.chdir('/home/users/xiangye/fzxl/carbonnanotube/cnt99/2tube/25/isolated/caledinSHNU/band')
os.system('pwd')
os.system('qsub vasp.pbs')